...
(function (factory) {
	...
	$('#modalParam').on('show.bs.modal', function (event) {
		var button = $(event.relatedTarget);
		var id = button.data('idupi');
		var modal = $(this);
		modal.find('input[type=hidden]').val(id);
	});

	$('#modalCheckbox').on('show.bs.modal', function (event) {
		var button = $(event.relatedTarget);
	...
	$('#modalCheckboxTwo').on('show.bs.modal', function (event) {
		var button = $(event.relatedTarget);
		var fc = button.data('formclass');
		var modal = $(this);
		$('.formContainer').html('');
